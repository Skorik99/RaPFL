...
def download_dataset(dataset_type, cfg):
    ...
    if dataset_type == "cifar10":
        from federated_datasets.cifar10_dataset import (
            download_cifar10,
            process_cifar10,
        )

        print("We will download CIFAR-10 dataset!")
        target_dir = get_target_dir(cfg, default_dir="cifar10")
        ...
        set_data_configs(target_dir, config_names=["cifar10.yaml"])
        set_base_path_configs(target_dir, config_names=["cifar10.yaml"])
        return target_dir
